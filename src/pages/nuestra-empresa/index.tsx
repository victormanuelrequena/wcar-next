...
import CardVisionComponent from "@/components/aboutUs/components/cardVision/CardVisionComponent";
  ...
  return (
    <div className="about_us_page">
      <Head>
        ...
        <meta
          name="keywords"
          content="Nuestra empresa wcar, Qué es wcar, Por qué wcar, valores wcar, misión wcar, visión wcar, wcar sas"
        />
      </Head>
      <Layout>
        <section className="w-100 position-relative section_1">
          <picture className="w-100">
            ...
            />
            <img
              srcSet="/assets/aboutUs/bg_1.jpg"
          ...
          <div className="container our_company">
            <div className="row d-flex flex-wrap">
              ...
              <div className="col-md-7 bg_white">
                <div className="info">
                  <div className="side side_top text_reduc bg_whiteed text_gray">
                    Por qué nosotros
                  </div>
                  <h1 className="text_bold h2">Nuestra Empresa</h1>
                  <p>
                    En Latam el mercado de autos usados es de 6 millones de
                    transacciones al año. WCar es el primer phygital ecosystem
                    que se dirige al 90% de las personas que hacen esas
                    transacciones de compra y venta de manera informal corriendo
                    grandes riesgos. También nos enfocamos en quienes no están
                    conformes con los concesionarios tradicionales ni las nuevas
                    plataformas completamente virtuales que deshumanizan el
                    proceso. En este revolucionario ecosistema nuestros clientes
                    encuentran consejería personalizada para adquirir autos
                    usados puestos a punto, además de productos complementarios
                    e indispensables como financiación, garantías, seguros y
                    trámites.
                  </p>
                  <Link
            ...
            <div className="row">
              <div className="col-md-2">
                <div className="side side_top side_blue_neon">
                  <h2>
                    <span className="text_bold text_black text_md_white">
                      Misión
                    </span>{" "}
              ...
              <div className="col-md-4 my-3">
                <CardVisionComponent
                  minTitle="Misión"
                  title="Inspirar a la generación actual y futura de compradores."
                  image={
                  ...
                  description="Brindamos una experiencia física y digital única, emocionante, basada en la transparencia brutal y precios razonables, potenciada por la última tecnología en IA y blockchain."
                />
              </div>
              <div className="col-md-4 my-3">
                <CardVisionComponent
                  minTitle="Visión"
                  title="Convertirnos en el referente en LATAM de la industria."
                  image={
                    <div className="text_orange">
                      {" "}
                      <Icons.HeartFilled />{" "}
                  ...
                  description="Construimos una comunidad de entusiastas del automóvil que celebre la innovación, la sostenibilidad y la tecnología, mientras transformamos la manera en que las personas compran y venden."
                />
              </div>
            </div>
          </div>
              ...
              <div className="col-md-6">
                <div className="row">
                  <div className="col-12">
                    <img
                      src="/assets/aboutUs/asset_1.jpg"
                      title="Nuestra empresa wcar #1 en Transparencia brutal"
                      alt="Nuestra empresa wcar #1 en Transparencia brutal"
                  ...
                  <div className="col-6 d-flex flex-column justify-content-space-between">
                    <img
                      src="/assets/aboutUs/asset_2.jpg"
                      title="Nuestra empresa wcar #1 en Transparencia brutal"
                      alt="Nuestra empresa wcar #1 en Transparencia brutal"
                      className="img-fluid mt-3 object_cover w-100"
                    />
                  ...
                  <div className="col-6">
                    <img
                      src="/assets/aboutUs/asset_4.jpg"
                      title="Nuestra empresa wcar #1 en Transparencia brutal"
                      alt="Nuestra empresa wcar #1 en Transparencia brutal"
                ...
                <AccordeonComponent
                  title={
                    <h2 className="font_bold h3">
                      Preguntas{" "}
                      <span className="text_orange text_italic">
                        frecuentes
                      </span>
                    </h2>
                  }
