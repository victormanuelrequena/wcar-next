...
import CardServiceComponent from "@/components/home/cardService/CardServiceComponent";
                ...
                <div className="col-12 col-sm-6">
                  <div className="d-flex flex-column">
                    ...
                    <h2 className="mt-3 h1">
                      Más que <br />
                      vender te <br />{" "}
                      <span className="my-3 text_orange text_italic">
                        aconsejamos
                      </span>
                    </h2>
                    <Link href={"/compra-tu-carro"}>
                      <button className="my-3 btn btn_orange btn_shadow btn_cut">
                        COMPRA TU CARRO <Icons.ArrowCircle />{" "}
                      </button>
                    </Link>
                    <Link href={"/vende-tu-carro"} className="mb-5">
            ...
            <div className="container">
              <div className="row d-flex flex-column-reverse flex-md-row">
                ...
                <div className="col-md-8 position-relative text-white px-5 ps-md-5 px-md-3 py-5">
                  ...
                  <div>
                    <p>
                      ¡Somos el anti-dealer para que compres y vendas con cero
                      estrés!{" "}
                    </p>
                    <p>
                      En este revolucionario ecosistema encuentras una
                      consejería personalizada. Somos brutalmente transparentes,
                      dando a conocer el estado real del vehículo y ofreciendo
                      precios razonables con un alto estándar de calidad.
                    </p>
                  </div>
