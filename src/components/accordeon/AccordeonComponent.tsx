...
import styles from "./AccordeonComponentStyles.module.scss";

const AccordeonComponent: FC<AccordeonComponentProps> = ({
  title,
  subtitle,
  options,
}) => {
  ...
  return (
    <div className={styles.accordeon_component}>
      <div className="w-100">
        <div className="side side_top">{title}</div>
