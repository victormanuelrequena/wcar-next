  ...
  return (
    <>
      ...
      <div className="container_nav w-100 d-flex">
        <div
          className={`arrow_slider_card me-1 ${
            indexCard === 0 ? "disabled" : null
          }`}
          onClick={previous}
        >
          <AiOutlineArrowLeft />
        ...
        <div
          className={`arrow_slider_card ms-1 ${
            indexCard === cars?.length - 1 ? "disabled" : null
          }`}
          onClick={next}
        >
          <AiOutlineArrowRight />
