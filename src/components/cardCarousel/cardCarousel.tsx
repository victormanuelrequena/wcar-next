...
export const CardCarousel: FC<{ car: any }> = ({ car }) => {
  ...
  return (
    <Link
      href={`${routes.detailedCar.relativePath}/${getUrlCar(car)}`}
      ...
      <div className="card-body rounded-bottom p-2 d-flex flex-column">
        {car?.tag_car && (
          <div
            ...
            style={{
              backgroundColor:
                car.tag_car.tag.toLowerCase() === "disponible"
                  ? null
                  : car.tag_car.color,
        ...
        <div
          ...
          style={{ fontSize: ".9em", margin: "auto" }}
        >
          ...
          <div className="col-3 d-flex align-items-center text_gray p-0">
            ...
            <span className="text_nowrap">
              {car?.transmission === 1 ? "Automática" : "Manual"}
            </span>
          </div>
        </div>
        <div
