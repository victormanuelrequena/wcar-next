        ...
        <div className="row">
          ...
          <div className="col-6 col-md-3 col-lg-2">
            <div className="d-flex flex-column w-100">
              ...
              <Link href={routes.aboutUs.relativePath} className="my-1">
                Nuestra Empresa
              </Link>
              <Link href={routes.buyYourCar.relativePath} className="my-1">
                Compra tu carro
              </Link>
              <Link href={routes.sellYourCar.relativePath} className="my-1">
                Vende tu carro
              </Link>
              <Link href={routes.services.relativePath} className="my-1">
                Financiación
              </Link>
              <Link href={routes.insurance.relativePath} className="my-1">
                Seguros
              </Link>
              <Link href={routes.procedures.relativePath} className="my-1">
                Trámites
              </Link>

              <Link
                href={routes.termAndConditionsUser.relativePath}
                className="my-1"
              >
                Términos y condiciones usuarios
              </Link>
              <Link
                href={routes.termAndConditionsSalesYesOrYes.relativePath}
                className="my-1"
              >
                Términos y Condiciones "Vende tu Carro Si o Si"
              </Link>
              <Link
                href={routes.termAndConditions.relativePath}
                className="my-1"
              >
                Términos y Condiciones Garantia
              </Link>
              <Link
                href={routes.privacyPolicyMobileApp.relativePath}
                className="my-1"
              >
                Políticas de privacidad para la aplicación móvil wcar
              </Link>
              <Link
                href={routes.dataPrivacyNoticeWcarAppUsers.relativePath}
                className="my-1"
              >
                Aviso de privacidad de datos para usuarios app wcar
              </Link>
              <Link href={routes.privacyPolicies.relativePath} className="my-1">
          ...
          <div className="col-6 col-md-3 col-lg-2">
            <div className="d-flex flex-column w-100">
              ...
              <p>
                Carrera 5 #9 - 26 sur, Cajicá, Cundinamarca Torre 3, Local 3.
                Sabana Park Health & Business
              </p>
              <a
          ...
          <div className="col-md-8 d-flex pb-5 pb-md-0">
            <div className="w-100 text_underline text_gray d-flex flex-column flex-md-row align-items-center align-items-md-end">
              <div className="mx-3 mt-3 mt-md-0">
                <Link href={routes.generalPolicies.relativePath}>
                  Políticas y tratamiento de datos
                </Link>
              </div>

              <div className="mx-3 mt-3 mt-md-0">
                <Link href={routes.buyerPolicies.relativePath}>
                  Términos y condiciones comprador
                </Link>
              </div>
              <div className="mx-3 mt-3 mt-md-0">
                <Link href={routes.sellerPolicies.relativePath}>
