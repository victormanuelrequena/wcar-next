...
import styles from "./CommentsLineComponentStyles.module.scss";
...
const CommenstLineComponent: FC<{}> = () => {
  ...
  return (
    <section className={styles.comments_line_component}>
      <img
      ...
      <div className="container">
        <div className="row">
          <div
            className={`col-md-3 d-md-flex justify-content-start justify-content-md-end align-items-center ${styles.black_side}`}
          >
            <div
              className={`side_top side_md_blue_neon text_black text_md_white mt-5 ms-3 mt-md-0 pe-5 ${styles.side}`}
            >
              <h2>
                <b>¿Qué </b>
